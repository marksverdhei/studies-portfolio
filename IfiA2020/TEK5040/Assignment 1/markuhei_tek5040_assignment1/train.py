...
def main(train_dir):
    ...
    # create_model = segmentation_models.simple_model
    create_model = segmentation_models.unet

    model = create_model((HEIGHT, WIDTH, 3))
    print(model.summary())
    print(f"Training on {create_model.__name__}")
    loss_fn = get_loss_fn()
